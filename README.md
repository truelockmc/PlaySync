...
3. **Configure Environment Variables**
   ...
   ```
   - **Spotify**: Get credentials from the [Spotify Developer Dashboard](https://developer.spotify.com/dashboard/). Also set `http://127.0.0.1:8888/callback` as your Applications Redirect URL
